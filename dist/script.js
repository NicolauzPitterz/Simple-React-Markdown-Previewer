...
class App extends React.Component {
  ...
  render() {
    ...
    ["editorWrap maximized", "previewWrap hide", "fas fa-compress-alt"] :
    this.state.previewMaximized ?
    ["editorWrap hide", "previewWrap maximized", "fas fa-compress-alt"] :
    ["editorWrap", "previewWrap", "fas fa-expand-arrows-alt"];
    return /*#__PURE__*/(
